...
const productsItemSchema = new mongoose.Schema({
  ...
  title: { type: String, required: true, maxlength: [30, 'Title must be at most 30 characters'] },
  price: { type: Number, required: true, max: [100000, 'Price must be at most 100000'] },
  description: { type: String, maxlength: [50, 'Description must be at most 50 characters'] },
  category: {
    type: String,
    enum: {
